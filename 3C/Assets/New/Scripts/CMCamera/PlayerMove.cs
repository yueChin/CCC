...
public class PlayerMove : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Vector3 desiredVelocity = input * Speed;
        Vector3 deltaVel = desiredVelocity - m_currentVleocity;
        ...
        if (RotatePlayer && m_currentVleocity.sqrMagnitude > 0.01f)
        {
            ...
            Quaternion qB = Quaternion.LookRotation((InputForward == ForwardMode.Player && Vector3.Dot(fwd, m_currentVleocity) < 0) ? -m_currentVleocity : m_currentVleocity);
