...
{   
    ...
    {   
        CinemachineVirtualCamera aa = CamLock.GetComponent<CinemachineVirtualCamera>();
        if (aa)
        {
            if (ret == false)
            {
    ...
    void LogCamDistance()
    {
        ...
        ICinemachineCamera curCam = brain.ActiveVirtualCamera;
        CinemachineVirtualCamera cVcam = curCam as CinemachineVirtualCamera;
        float a = Vector3.Distance(cVcam.transform.position, transform.position);
    ...
    {         
        ...
        {   
            ...
            */
            ...
            group.m_Targets[0].target = Enemy.transform;
            // TPS to Lock 
    ...
    {      
        ...
        {     
            this.LogCamDistance();
            CinemachineVirtualCamera a = CamTPS.GetComponent<CinemachineVirtualCamera>();
    ...
    {   
        ...
        Vector3 r = cam.WorldToScreenPoint(transform.position);
        Vector2 r2 = new Vector2(r.x - cam.pixelWidth * 0.5f, r.y - cam.pixelHeight * 0.5f);
